        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DeveloperName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PropertyModels_Owners_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Owners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_PropertyModels_Projects_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyModels_OwnerId",
                table: "PropertyModels",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyModels_ProjectId",
                table: "PropertyModels",
                column: "ProjectId");
        }
